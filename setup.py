...
setup(
    ...
    packages=['venv.Lib.site-packages.cv2', 'venv.Lib.site-packages.cv2.data', 'venv.Lib.site-packages.PIL',
              ...
              'venv.Lib.site-packages.numpy.polynomial.tests', 'venv.Lib.site-packages.pyrect',
              'venv.Lib.site-packages.pymsgbox', 'venv.Lib.site-packages.mouseinfo', 'venv.Lib.site-packages.pyautogui',
              'venv.Lib.site-packages.pyperclip', 'venv.Lib.site-packages.pyscreeze',
              'venv.Lib.site-packages.pytweening', 'venv.Lib.site-packages.pygetwindow',
    ...
    author='User',
    author_email='',
    description='', install_requires=['cv2', 'PIL', 'numpy', 'wx', 'pyWinhook', 'efficientnet', 'tensorflow']
)
